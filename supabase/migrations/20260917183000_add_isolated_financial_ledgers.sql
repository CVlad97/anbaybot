...
CREATE UNIQUE INDEX IF NOT EXISTS uq_trade_ledger_source_ref
  ON trade_ledger(source, source_ref)
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_pnl_ledger_source_ref
  ON pnl_ledger(source, source_ref)
  WHERE source_ref IS NOT NULL;
...
BEFORE UPDATE OR DELETE ON trade_ledger
...
CREATE TRIGGER trg_pnl_ledger_immutable
